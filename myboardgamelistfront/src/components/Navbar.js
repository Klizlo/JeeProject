...
const Navbar = () => {
  ...
  const user = localStorage.getItem("token") != null ? (localStorage.getItem("token")) : (sessionStorage.getItem("token"));
  ...
  return (
    <AppBar position="static" sx={{
      ...
      <Container maxWidth="xl">
        { user != null ? (<Toolbar disableGutters>
          ...
          <Toolbar disableGutters>
            <Box component="img" src="logo.png" sx={{ width: "48px", display: 'flex', mr: 1 }} />
            <Typography
              variant="h5"
              noWrap
              component={Link}
